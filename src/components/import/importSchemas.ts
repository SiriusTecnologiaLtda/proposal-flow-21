...
export const SALES_TARGETS_DB_FIELDS: DbField[] = [
  ...
  { key: "category_code", label: "Código Categoria", required: false, aliases: ["cod receita", "cód receita", "código receita", "cod categoria", "código categoria", "codreceita", "codcategoria"] },
  { key: "segment_name", label: "Segmento", required: false, aliases: ["segmento", "segment", "seg", "linha"] },
  { key: "segment_code", label: "Código Segmento", required: false, aliases: ["cod segmento", "cód segmento", "código segmento", "codsegmento"] },
