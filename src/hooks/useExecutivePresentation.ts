...
import type { PresentationTypeConfig, OpportunityData, LinkedProject, ProjectScopeGroup, TemplateKnowledge, ProposalTemplateContext } from "@/data/executivePresentationData";
