...
export default function CoverSection({ data, editable, overrides, onEdit }: Props) {
  ...
  return (
    <section className="relative overflow-hidden rounded-xl bg-gradient-to-br from-[hsl(var(--hero-from))] via-[hsl(var(--hero-via))] to-[hsl(var(--hero-to))] px-8 py-16 text-primary-foreground md:px-16 md:py-24">
      {/* Decorative elements */}
      ...
      <div className="relative z-10 max-w-3xl space-y-6">
        ...
        {editable ? (
          ...
          <p className="text-lg leading-relaxed text-primary-foreground/80 md:text-xl">{subtitle}</p>
        )}

        <div className="flex flex-wrap items-center gap-6 pt-4 text-sm text-primary-foreground/60">
          <span className="font-semibold text-primary-foreground">{data.company}</span>
